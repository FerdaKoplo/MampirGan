...
namespace MampirGan_Automata__dan_Table_driven_.Fitur
{
    ...
    public class CheckoutService
    {
        ...
        private readonly string checkoutDataPath = "C:\\Users\\IVAN\\Documents\\Project_C#\\MampirGan-Automata-Table-driven-only-\\MampirGan(Automata, dan Table driven)\\MampirGan(Automata, dan Table driven)\\Jsons\\CheckoutData.json";
